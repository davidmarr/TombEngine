...
static constexpr char ScriptReserved_OnUseItemCallBack[]			= "OnUseItemCallBack";
...
constexpr char ScriptReserved_DrawItemSetColor[]	= "SetItemColor";
constexpr char ScriptReserved_DrawItemSetVisibility[] = "SetItemVisibility";
constexpr char ScriptReserved_DrawItemSetMeshBits[] = "SetItemMeshbits";
constexpr char ScriptReserved_DrawItemGetPosition[] = "GetItemPosition";
constexpr char ScriptReserved_DrawItemSetObjectID[] = "SetObjectID";
constexpr char ScriptReserved_DrawItemGetObjectID[] = "GetObjectID";
...
constexpr char ScriptReserved_DrawItemSetCamera[]	= "SetInvCameraPosition";
constexpr char ScriptReserved_DrawItemGetTarget[]	= "GetInvTargetPosition";
constexpr char ScriptReserved_DrawItemSetTarget[]	= "SetInvTargetPosition";
