...
static constexpr char ScriptReserved_CompareTables[]				= "CompareTables";
static constexpr char ScriptReserved_TableReadonly[]				= "TableReadonly";
static constexpr char ScriptReserved_TableHasValue[]				= "TableHasValue";
static constexpr char ScriptReserved_TableHasKey[]					= "TableHasKey";
static constexpr char ScriptReserved_SplitString[]					= "SplitString";
static constexpr char ScriptReserved_Lerp[]							= "Lerp";
static constexpr char ScriptReserved_Smoothstep[]					= "Smoothstep";
