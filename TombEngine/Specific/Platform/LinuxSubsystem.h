...
{
	// Linux-specific implementation of the platform subsystem.
	class LinuxSubsystem final : public ISubsystem
	{
	private:
		// Fields
	...
	public:
		...
		std::string                 GetBinaryPath(bool includeExeName) override;
