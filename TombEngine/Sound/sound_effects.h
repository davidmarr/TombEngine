...
enum SOUND_EFFECTS
{
	...
	SFX_TR3_SOFIALEIGH_DEATH_PART_1 = 697,
	SFX_TR3_SOFIALEIGH_DEATH_PART_2 = 698,
	SFX_TR3_SOFIALEIGH_FIRE = 699,
	SFX_TR3_SOFIALEIGH_LAUGH = 700,
	SFX_TR3_SOFIALEIGH_SHOOTER = 701,
	SFX_TR3_SOFIALEIGH_SUMMON = 702,
	SFX_TR3_SOFIALEIGH_SUMMON_FAIL = 703,
	SFX_TR3_SOFIALEIGH_TAKE_HIT = 704,
	SFX_TR3_SOFIALEIGH_VAULT = 705,
	...
	SFX_TR1_COWBOY_DEATH = 1147,
	SFX_TR1_NATLA_DEATH = 1148,
	SFX_TR1_NATLA_SPEECH = 1149,

	// TombEngine sounds

	SFX_TEN_CUSTOM_FOOTSTEPS_1 = 1150,
	SFX_TEN_CUSTOM_FOOTSTEPS_2 = 1151,
	SFX_TEN_CUSTOM_FOOTSTEPS_3 = 1152,
	SFX_TEN_CUSTOM_FOOTSTEPS_4 = 1153,
	SFX_TEN_CUSTOM_FOOTSTEPS_5 = 1154,
	SFX_TEN_CUSTOM_FOOTSTEPS_6 = 1155,
	SFX_TEN_CUSTOM_FOOTSTEPS_7 = 1156,
	SFX_TEN_CUSTOM_FOOTSTEPS_8 = 1157,

	// Pushable sounds

	SFX_TEN_PUSHABLES_MOVE_MUD = 1158,
	SFX_TEN_PUSHABLES_STOP_MUD = 1159,
	SFX_TEN_PUSHABLES_COLLIDE_MUD = 1160,
	SFX_TEN_PUSHABLES_MOVE_SNOW = 1161,
	SFX_TEN_PUSHABLES_STOP_SNOW = 1162,
	SFX_TEN_PUSHABLES_COLLIDE_SNOW = 1163,
	SFX_TEN_PUSHABLES_MOVE_SAND = 1164,
	SFX_TEN_PUSHABLES_STOP_SAND = 1165,
	SFX_TEN_PUSHABLES_COLLIDE_SAND = 1166,
	SFX_TEN_PUSHABLES_MOVE_GRAVEL = 1167,
	SFX_TEN_PUSHABLES_STOP_GRAVEL = 1168,
	SFX_TEN_PUSHABLES_COLLIDE_GRAVEL = 1169,
	SFX_TEN_PUSHABLES_MOVE_ICE = 1170,
	SFX_TEN_PUSHABLES_STOP_ICE = 1171,
	SFX_TEN_PUSHABLES_COLLIDE_ICE = 1172,
	SFX_TEN_PUSHABLES_MOVE_WATER = 1173,
	SFX_TEN_PUSHABLES_STOP_WATER = 1174,
	SFX_TEN_PUSHABLES_COLLIDE_WATER = 1175,
	SFX_TEN_PUSHABLES_MOVE_STONE = 1176,
	SFX_TEN_PUSHABLES_STOP_STONE = 1177,
	SFX_TEN_PUSHABLES_COLLIDE_STONE = 1178,
	SFX_TEN_PUSHABLES_MOVE_WOOD = 1179,
	SFX_TEN_PUSHABLES_STOP_WOOD = 1180,
	SFX_TEN_PUSHABLES_COLLIDE_WOOD = 1181,
	SFX_TEN_PUSHABLES_MOVE_METAL = 1182,
	SFX_TEN_PUSHABLES_STOP_METAL = 1183,
	SFX_TEN_PUSHABLES_COLLIDE_METAL = 1184,
	SFX_TEN_PUSHABLES_MOVE_MARBLE = 1185,
	SFX_TEN_PUSHABLES_STOP_MARBLE = 1186,
	SFX_TEN_PUSHABLES_COLLIDE_MARBLE = 1187,
	SFX_TEN_PUSHABLES_MOVE_GRASS = 1188,
	SFX_TEN_PUSHABLES_STOP_GRASS = 1189,
	SFX_TEN_PUSHABLES_COLLIDE_GRASS = 1190,
	SFX_TEN_PUSHABLES_MOVE_CONCRETE = 1191,
	SFX_TEN_PUSHABLES_STOP_CONCRETE = 1192,
	SFX_TEN_PUSHABLES_COLLIDE_CONCRETE = 1193,

	// Additional missing sounds from catalog

	SFX_TEN_STEAM_EMITTER_LOOP = 1194,
	SFX_TEN_MOVING_LASER_LOOP = 1195,
	SFX_TR1_LARSON_SPEECH = 1196,
	SFX_TR1_KOLD_SPEECH = 1197,
	SFX_TR1_COWBOY_SPEECH = 1198,
	SFX_TR1_SKATEBOARDKID_SPEECH = 1199,
	SFX_TR2_ROLLING_BARREL_ROLL = 1200,
	SFX_TR2_ROLLING_BARREL_STOP = 1201,

	// Custom sounds from 1196 onward
