...
namespace TEN::Renderer::Native::DirectX11
{
	...
	public:
		...
		DX11Texture2DArray() : Resolution(0), Viewport({}) {};

		DX11Texture2DArray(ID3D11Device* device, int resolution, int count, DXGI_FORMAT colorFormat, DXGI_FORMAT depthFormat)
