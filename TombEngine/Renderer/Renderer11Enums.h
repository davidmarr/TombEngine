...
enum TEXTURE_REGISTERS
{
	...
	TEXTURE_HUD = 5,
	TEXTURE_DEPTH_MAP = 6,
	TEXTURE_SHADOW_MAP_CUBE = 7,
	TEXTURE_SHADOW_MAP_PARABOLOID_FRONT = 8,
	TEXTURE_SHADOW_MAP_PARABOLOID_BACK = 9
};
