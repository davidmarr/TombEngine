...
namespace TEN::Gui
{
	...
	InventoryObject InventoryObjectTable[INVENTORY_TABLE_SIZE] =
	{
		...
		{ ID_SHOTGUN_AMMO1_ITEM, 0, 0.5f, EulerAngles(0, ANGLE(-90.0f), 0), OPT_USE, STRING_SHOTGUN_AMMO_1, NO_JOINT_BITS, INV_ROT_Y },
		...
		{ ID_GRENADE_AMMO3_ITEM, 3, 0.5f, EulerAngles(0, ANGLE(-90.0f), 0), OPT_USE, STRING_GRENADE_LAUNCHER_AMMO_3, NO_JOINT_BITS, INV_ROT_Y },
		...
		{ ID_HARPOON_AMMO_ITEM, 3, 0.5f, EulerAngles(ANGLE(15.0f), 0, 0), OPT_USE, STRING_HARPOON_GUN_AMMO, NO_JOINT_BITS, INV_ROT_Y },
		...
		{ ID_ROCKET_LAUNCHER_AMMO_ITEM, 3, 0.5f, EulerAngles(0, ANGLE(90.0f), ANGLE(15.0f)), OPT_USE, STRING_ROCKET_LAUNCHER_AMMO, NO_JOINT_BITS, INV_ROT_Y },
